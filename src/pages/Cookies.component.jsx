...
class Cookies extends React.Component {
    ...
    render() {
    	return (<Page>
        			<Helmet>
                        <title>{__SITE_NAME} - Cookie Policy</title>
                    </Helmet>
                    <TitleBanner title="Cookie Policy"/>
			            ...
			            <div className='container'>
			                <div className='row'>
			                    <div className='span12' >
									...
									<p>This is the Cookie Policy for Force Of Habit, accessible from http://forceofhab.it/</p>
									...
									<ul>
										<li>By visiting this link: http://forceofhab.it/contact/</li>
									</ul>
