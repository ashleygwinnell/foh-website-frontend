...
This SERVICE is provided by Force Of Habit Ltd at no cost and is intended for use as is.
...
For a better experience, while using our Service, we may require you to provide us with certain personally identifiable information, including but not limited to %PERSONAL_INFORMATION%. The term Advertising ID refers to the Google Advertising ID on Android devices, and ID For Advertising (“IDFA”) or ID For Vendor (“IDFV”) on iOS devices. The information that we request will be retained by us and used as described in this privacy policy.
